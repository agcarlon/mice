...
def sgd_svrg(dataset, batchsize, Lambda, epochs, seed=0):
    print(f"Solving logistic regression of {dataset} dataset using SVRG")
    ...
    out_dir = dataset_dir / "svrg" / str(seed)
...
def main() -> int:
    ...
    sgd_svrg(args.dataset, args.batchsize, lambda_reg, epochs, seed=args.seed)
    return 0
